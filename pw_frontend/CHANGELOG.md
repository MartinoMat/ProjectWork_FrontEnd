...
- Creare un progetto react con create-vite: `npm init --yes vite@latest pw_frontend -- --template=react  --no-rolldown --no-immediate`.
- Aggiornamento di `vite.config.js` con porta.
- Creare il file di progetto (`pw_frontend.esproj`).
